...
export default function Representante({dataRepresentative}) {
  return (
    <div className={`flex flex-col justify-center items-center my-10 relative bg-cover bg-[url(${dataRepresentative.fondo})] md:bg-[url(${dataRepresentative.fondoDesk})]`} >
